...
/***/ function(module, exports, __webpack_require__) {
	...
	ReactDOM.render(React.createElement(Greeter, { name: firstName, message: msg }), document.getElementById('app'));
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        'div',
	        null,
	        React.createElement('textarea', { ref: 'message', placeholder: 'type a message' })
	      ),
	      React.createElement(
	        'div',
	        null,
