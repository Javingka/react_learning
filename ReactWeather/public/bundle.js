...
/***/ function(module, exports, __webpack_require__) {
	...
	var _require = __webpack_require__(159),
	    Link = _require.Link,
	    IndexLink = _require.IndexLink; // this is an ECMAS6  syntax
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Weather = React.createClass({
	  ...
	  handleNewData: function handleNewData(data) {
	    ...
	    openWeatherMap.getTemp(data.location).then(function (_temp) {
	      that.setState({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OPEN_WEATHER_MAP_URL = 'http://api.openweathermap.org/data/2.5/weather?appid=89527fe80a220aa9580d545bc06cdb8c&units=metric';
